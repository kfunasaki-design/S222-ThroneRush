...
Forumは、参加ギルド間の連絡や調整に使用する共有スペースです。同盟への登録が完了すると各ギルド専用のチャンネルが開設され、チャンネル一覧から現在参加している同盟ギルドを確認できます。

### Guild Channels

各ギルド専用のチャンネルは、ギルド間の連絡や交渉に使用します。

必要な情報や調整内容を共有し、継続的なやり取りを行うことができます。

### Call to Arms

「⚔️Call to Arms」は、同盟全体に向けて協力を呼びかけるための共通スペースです。

特定の相手ではなく、不特定多数の参加ギルドに対して応援や協力を要請できます。
